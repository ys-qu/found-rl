...
"""
    ...
    from rwkv_v7.src.trainer import train_callback
    from rwkv_v7.src.dataset import MyDataset, multi_image_collate_fn
    ...
    # init training data
    args.tokenizer = TRIE_TOKENIZER("rwkv_v7/tokenizer/rwkv_vocab_v20230424.txt")
