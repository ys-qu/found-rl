...
class Valeo(object):
    ...
    def __init__(self, ego_vehicle, exploration_suggest=True, eval_mode=False, neglect_rl_stop=False):
    ...
    def get(self, timestamp):
        ...
        debug_texts = [
            ...
            f'ev: {int(self._eval_mode)} col:{int(c_collision)}-{collision_type}',
