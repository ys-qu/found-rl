...
class Collision():
    def __init__(self, vehicle, carla_world, intensity_threshold=400.0,
    ...
    def _on_collision(weakself, event):
        ...
        print(f'collision_type: {collision_type}, collision_type_id: {event.other_actor.type_id}, intensity: {intensity}')
