...
class ObsManager(ObsManagerBase):
    ...
    def _define_obs_space(self):
        self.obs_space = spaces.Dict({
            ...
            'command': spaces.Box(low=-1, high=6, shape=(self._steps,), dtype=np.int8),
            'road_id': spaces.Box(low=0, high=6000, shape=(self._steps,), dtype=np.uint16),
    ...
    def get_observation(self):
        ...
        obs_dict = {
            ...
            'road_id': np.array(road_id, dtype=np.uint16),
