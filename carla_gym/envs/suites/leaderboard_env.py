...
class LeaderboardEnv(CarlaMultiAgentEnv):
    def __init__(self, carla_map, host, port, seed, no_rendering, obs_configs, reward_configs, terminal_configs,
                 weather_group, routes_group, light_always_green, disbale_bg_actors):
    ...
    def build_all_tasks(carla_map, weather_group, routes_group):
        ...
        num_zombie_walkers = {
            ...
            'Town03': 70,
            'Town04': 80,
            'Town05': 40,  # town 05 is a big map, to prevent carla crash in eval, we reduce the number of walkers (120->40)
            'Town06': 80
        }
