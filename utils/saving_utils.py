...
class DataWriter():
    ...
    def write(self, timestamp, obs, supervision, reward, done=None, control_diff=None):
        ...
        data_dict['done'] = done[self._ev_id]
        ...
        if valid:
            ...
            for idx, data in enumerate(self._data_list):
                if do_save[idx]:
                    ...
                    self._write_dict_to_group(group_step, 'reward_done', {'reward': data['reward'], 'done': data['done']})
